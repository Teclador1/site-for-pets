export const data = [
  ...
  const createCard = () => {
    ...
    const sliderPetList = document.querySelector('.our-friends__slider');
    ...
    <h3 class="card__name">${el.name}</h3>
  ...
  const sliderPrevButton = document.querySelector('.left-button')
  const sliderNextButton = document.querySelector('.right-button')
